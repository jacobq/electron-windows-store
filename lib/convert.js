    ...
    .then(() => {
      ...
      .then(manifestTemplate => {
        ...
        return writeFile(manifest, template(manifestTemplate)({
          ...
          logo: Object.assign({
            '44x44': path.join('assets', 'SampleAppx.44x44.png'),
            '50x50': path.join('assets', 'SampleAppx.50x50.png'),
            '150x150': path.join('assets', 'SampleAppx.150x150.png'),
            '310x150': path.join('assets', 'SampleAppx.310x150.png')
          }, program.logo), // TODO: document
